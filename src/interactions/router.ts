...
interactions.post('/', async (c) => {
  ...
  switch (payload.type) {
    ...
    case InteractionType.MESSAGE_COMPONENT: {
      ...
      // All other portal:* buttons (including portal:weight:<adId>, the
      // per-banner weight-change button) route through the dashboard handler,
      // which gates on ownership before returning the weight modal.
